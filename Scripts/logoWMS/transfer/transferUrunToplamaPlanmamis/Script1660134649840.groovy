...
Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/anaSayfa_transferKutuYeni'), 0)

Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/transferUrunToplama_kutu'), 0)

Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/transferUrunTop_devamEdenEklemeButonu_Arti'), 0)

Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/urunToplamaPlanlanmamis/transferUrunTop_planlanmamislar_Kutu'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/urunToplamaPlanlanmamis/transferUrunTop_planlanmamis_894_CheckBox'), 0)

Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/urunToplamaPlanlanmamis/transferUrunTop_planlanmamislar_EkleSimgesiArti'), 
    0)
...
Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/urunToplamaPlanlanmamis/transferUrunTop_siparisUrunKirazKutu'), 0)
...
Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/urunToplamaPlanlanmamis/transferUrunTop_islem894_kaynak_FR1'), 0)

Mobile.tap(findTestObject('WMS/uretimdenGiris/transferUrunToplama/urunToplamaPlanlanmamis/transferUrunTop_islemKaynakAdr_TAMAM'), 0)
