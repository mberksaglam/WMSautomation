...
Mobile.tap(findTestObject('WMS/hizliUretim/uretim_hizliUretim_temizle'), 0)

Mobile.tap(findTestObject('WMS/hizliUretim/uretim_hizliUretim_temizleTamam'), 0)

Mobile.tap(findTestObject('WMS/hizliUretim/hizliUretimGeriTusu'), 0)

Mobile.tap(findTestObject('WMS/hizliUretim/hizliUretimCikis- TAMAM'), 0)
